...
export default function FirstScreen(){
    return(
        <div className="fisrtsection flex w-full pt-[30px] xs:flex-col xs:gap-[50px] box-border overflow-x-hidden">
            <div className="relative w-[600px] xs:w-full pt-[70px] pl-[140px] xs:pl-[40px] pr-[60px] flex xs:h-[310px]">
                <img  src={flights} alt='flights' className='absolute w-[329px] top-0'/>
            ...
            <div className="flex flex-col justify-center items-center gap-[30px] w-[500px] xs:w-full pt-[80px] box-border">
                <p className='font-[700] text-[24px] text-[#00A0B1] xs:hidden'>Исследуйте Грузию</p>
                <h1 className='text-[70px] xs:text-[30px] xs:text-center leading-[4rem] font-[500] xs:w-[80%] xs:leading-[3rem]'>Пора путешествовать в Грузии</h1>
                <p className='text-[16px] w-[400px] xs:text-center'>Дружеское объединение гидов-грузин. Узнай страну от тех, кто в ней родился и живёт!</p>
