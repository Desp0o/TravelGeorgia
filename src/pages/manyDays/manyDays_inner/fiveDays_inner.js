    ...
    return (
        ...
        <div className="w-full">
            ...
            <div className='w-full pl-[120px] xs:pl-[20px] pt-[20px] pr-[120px] xs:pr-[20px] xl:pl-[400px] xl:pr-[400px]' >
                ...
                <br />
                <li>Конечный пункт — высокогорная церковь Святой Троицы (Самеба) в Гергети. 2170 м над уровнем моря. С интересной историей и легендами. Почитаемыми святынями, природным источником святой воды. Возможность подняться на верх как на спецтранспорте, так и пешком (два пути — длинный и короткий).</li>
                <br />
